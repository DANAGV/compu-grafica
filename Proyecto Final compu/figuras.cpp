...
//DETALLES DE LA CASA, PAREDES, VENTANA, ESCALERA
...
void CFiguras::prisma12(float altura, float largo, float profundidad, GLuint text)  //Funcion creacion prisma
{
...
//PRISMA PARA EL BLOQUE IZQUIERDO DE LA CASA
void CFiguras::prisma4(float altura, float largo, float profundidad, GLuint text, GLuint text2)  //Funcion creacion prisma
{
...
void CFiguras::prisma5(float altura, float largo, float profundidad, GLuint text, GLuint text1, GLuint text2, GLuint text3, GLuint text4, GLuint text5)  //Funcion creacion prisma
{
...
void CFiguras::prisma6(float altura, float largo, float profundidad, GLuint text, GLuint text2)  //Funcion creacion prisma
{
...
void CFiguras::prisma7(float altura, float largo, float profundidad, GLuint text, GLuint text2)  //Funcion creacion prisma
{
...
void CFiguras::prisma8(float altura, float largo, float profundidad, GLuint text)  //Funcion creacion prisma
{
...
void CFiguras::prisma9(float altura, float largo, float profundidad, GLuint text)  //Funcion creacion prisma
{
...
void CFiguras::prisma10(float altura, float largo, float profundidad, GLuint text)  //Funcion creacion prisma
{
...
void CFiguras::prisma11(float altura, float largo, float profundidad, GLuint text)  //Funcion creacion prisma
{
