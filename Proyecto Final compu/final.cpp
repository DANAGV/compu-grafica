	...
	glPushMatrix();
		...
		glPushMatrix();		
			...
			glPushMatrix();
				...
				//Para detener el carro en 100 unidades
				...
				glTranslatef(0, movKit1, movKit);

				//Pongo aquí la carroceria del carro
				kit.GLrender(NULL,_SHADED,1.0);  //_WIRED O _POINTS //Cargar la figura en escena
			...
			glVertex3f(4.0, 10.0, 7.0);
			glVertex3f(0.0, 0.0, 10.0);
			glEnd();

			glPopMatrix();

			glTranslatef(3.0, 10.0, 3.0);
			glBegin(GL_QUADS);
			glVertex3f(0.0, 0.0, 0.0);
